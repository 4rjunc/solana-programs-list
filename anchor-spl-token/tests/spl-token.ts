...
describe("spl-token", () => {
  ...
  it("Mint Tokens with PDA mint authority", async () => {
    console.log("============================================================")
    console.log("Mint Tokens with PDA mint authority")
    console.log("============================================================")
    ...
    const tx = await program.methods
      .mintTokenPda(new anchor.BN(100))
      // mint account and ata is included by anchor itself
      .accounts({
        tokenProgram: TOKEN_2022_PROGRAM_ID,
      })
      .rpc({ commitment: "confirmed" });
